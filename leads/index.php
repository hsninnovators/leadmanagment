...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h3>Leads</h3>
    <div>
        <a class="btn btn-outline-secondary btn-sm" href="/leads/import.php">CSV Import</a>
        <a class="btn btn-outline-secondary btn-sm" href="/leads/export.php?<?= e(http_build_query($_GET)) ?>">CSV Export</a>
        <a class="btn btn-primary btn-sm" href="/leads/create.php">Add Lead</a>
    </div>
</div>
...
<td><a class="btn btn-sm btn-outline-primary" href="/leads/view.php?id=<?= (int)$l['id'] ?>">View</a></td>
</tr>
<?php endforeach; ?>
</tbody>
</table>
